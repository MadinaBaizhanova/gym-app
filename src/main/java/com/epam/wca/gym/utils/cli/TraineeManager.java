...
public final class TraineeManager {
    ...
    public TraineeManager(GymFacade gymFacade, Scanner scanner) {
    ...
    private void createTrainee() {
        ...
        gymFacade.trainee().createTrainee(firstName, lastName, dateOfBirth, address);
    }
